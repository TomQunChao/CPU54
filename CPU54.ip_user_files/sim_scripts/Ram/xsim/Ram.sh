...
#
# Generated by Vivado on Fri Jun 14 08:59:29 +0800 2019
...
# Script info
echo -e "Ram.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Ram xil_defaultlib.Ram xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/ProgramFiles/Xilinx/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
